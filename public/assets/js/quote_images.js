...
function ToggleDesktopAndMobileImagesBeforeAndAfter(){
  ...
  if(document.getElementById("quote_image_what_we_do")){
    ...
    if(window.innerWidth <= 844){
      quote_image_background.setAttribute("src","./assets/mobile_what_we_do_2.png");
      quote_showcase_background.setAttribute("src","./assets/mobile_quote_showcase.png");
...
ToggleDesktopAndMobileImagesBeforeAndAfter();
